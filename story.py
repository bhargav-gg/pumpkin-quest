intro_story = [
    ...
    "______ was enrolled in a programming course taught by Professor Drachova.",
    ...
    "The mysterious man told ______ that the Pumpkin of Halloween was the head of a scarecrow in a dark, secluded maze, that the Pumpkin of Thanksgiving was at the head of a Thanksgiving party between the Pilgrims and the Native Americans, and that the Pumpkin of Christmas was the head of an animate and defensive snowman.",
...
thanksgiving_story = [
    ...
    "However, when you entered the venue, you were recognized as an unfamiliar outsider and chased out by those attending. Your mission is clear: get the Pumpkin of Thanksgiving without being seen and get out.",
    "Unforunately for you, due to the time rift you have caused, the Pilgrims and Native Americans have gained some allies: the Watchers. Greyish, sentient golems that tower over you and are watching out for thieves like you. Good luck, ______."
]
...
secret_story = [
    "After finding the Pumpkin of Christmas, you make it back to campus and try to go back to your dorm. However, you are stopped by a mysterious figure...",
...
secret_aftermath = [
    "You have defeated Professor Drachova and passed the class. Congratulations, ______. You have completed Pumpkin Quest."
]
